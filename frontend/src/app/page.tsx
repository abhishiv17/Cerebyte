      ...
      <section className="relative z-10 bg-white">
        <div className="grid grid-cols-1 md:grid-cols-4 border-b-2 border-brand-black">
          {[
            ...
            <div 
              key={title} 
              className={`group p-6 border-brand-black transition-colors duration-200 ${idx !== 3 ? 'md:border-r-2' : ''} ${idx !== 0 ? 'border-t-2 md:border-t-0' : ''} bg-[#f4f4ec] hover:bg-brand-black text-brand-black hover:text-white`}
            >
